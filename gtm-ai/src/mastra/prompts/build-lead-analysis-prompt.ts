...
### Instructions
1. Determine if the content is a lead (isLead: true/false).
2. If it is a lead, extract:
   - "whyFit": explain why the lead may fit dOrg's services.
   - "needs": what the author/poster needs help with.
   - "timing": if a timeframe is mentioned, extract it. If not, use null.
   - "contactInfo": Extract all contact info mentioned (username, email, discord, twitter, website, company name, etc). If the content is a social media post, always include the author's username.
...
{
  "isLead": true,
  "whyFit": "The author represents a funded Web3 startup actively seeking an established dev shop for a team extension engagement, requiring deep expertise in mechanism design and full-stack development, which perfectly aligns with dOrg's B2B model and core services.",
...
{ 
  "isLead": true, 
  "whyFit": "The author is looking for a freelance developer to help build an app MVP", 
